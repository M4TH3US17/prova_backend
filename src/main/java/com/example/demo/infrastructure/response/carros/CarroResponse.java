package com.example.demo.infrastructure.response.carros;
...
public class CarroResponse {
    ...
    @ApiModelProperty(value = "Mensagem de retorno do sistema", example = "Carro Cadastrado com sucesso.", required = true)
